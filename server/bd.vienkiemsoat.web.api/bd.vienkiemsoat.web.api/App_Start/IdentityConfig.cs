...
namespace bd.vienkiemsoat.web.api
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, Guid>
    {
        ...
        {
            var userStore = new UserStore<ApplicationUser, ApplicationRole, Guid, CustomUserLogin, CustomUserRole, CustomUserClaim>(context.Get<ApplicationIdentityContext>());
