...
namespace bd.vienkiemsoat.web.api.Controllers
{
    public class ReportController : BaseController
    {
        ...
        [HttpPost]
        public HttpResponseMessage ExportPDF([FromBody]SearchModel model)
        {
            var root = System.Web.Hosting.HostingEnvironment.MapPath("~/bin/Report");
            ...
            {
                { "vuan", new List<string>() },
            };
            var fileBytes = _reportService.ExportPDF(path, dataset, paras);
